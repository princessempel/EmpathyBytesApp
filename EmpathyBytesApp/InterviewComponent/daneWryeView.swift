...
//  EmpathyBytesApp
//
//  Created by Princess Empel on 4/17/22.
//
import SwiftUI
import AVKit

struct daneWryeView: View {
    var body: some View {
        daneWryePlayer()
    }
}

struct daneWryeView_Previews: PreviewProvider {
    static var previews: some View {
        daneWryeView()
    }
}

struct daneWryePlayer : View {
    ...
    @State var del = AVdelegateDaneWrye()
...
class AVdelegateDaneWrye : NSObject,AVAudioPlayerDelegate{
